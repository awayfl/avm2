...
export class b2Math{
	...
	public static b2MulTMV(A:b2Mat22, v:b2Vec2):b2Vec2
	{
		...
		var u:b2Vec2 = new b2Vec2(this.b2Dot(v, A.col1), this.b2Dot(v, A.col2));
		return u;
	}
	
	public static b2MulX(T:b2XForm, v:b2Vec2) : b2Vec2
	{
		var a:b2Vec2 = this.b2MulMV(T.R, v);
		a.x += T.position.x;
		a.y += T.position.y;
	...
	{
		var a:b2Vec2 = this.SubtractVV(v, T.position);
	...
	{
		var C:b2Mat22 = new b2Mat22(0, this.AddVV(A.col1, B.col1), this.AddVV(A.col2, B.col2));
		return C;
	}
	...
	{
		var C:b2Mat22 = new b2Mat22(0, this.b2MulMV(A, B.col1), this.b2MulMV(A, B.col2));
		return C;
	}
	...
	{
		var c1:b2Vec2 = new b2Vec2(this.b2Dot(A.col1, B.col1), this.b2Dot(A.col2, B.col1));
		var c2:b2Vec2 = new b2Vec2(this.b2Dot(A.col1, B.col2), this.b2Dot(A.col2, B.col2));
	...
	{
		var b:b2Vec2 = new b2Vec2(this.b2Abs(a.x), this.b2Abs(a.y));
		return b;
	}

	public static b2AbsM(A:b2Mat22):b2Mat22
	{
		var B:b2Mat22 = new b2Mat22(0, this.b2AbsV(A.col1), this.b2AbsV(A.col2));
		return B;
	}
	...
	{
		var c:b2Vec2 = new b2Vec2(this.b2Min(a.x, b.x), this.b2Min(a.y, b.y));
		return c;
	}
	...
	{
		var c:b2Vec2 = new b2Vec2(this.b2Max(a.x, b.x), this.b2Max(a.y, b.y));
		return c;
	}
