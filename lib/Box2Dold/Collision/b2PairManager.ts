...
//public:
	...
	*/
	...
	public Commit() : void{
		...
		var removeCount:number /** int */ = 0;
		
		var proxies:b2Proxy[] = this.m_broadPhase.m_proxyPool;
...
//private:
	...
	private AddPair(proxyId1:number /** uint */, proxyId2:number /** uint */):b2Pair{
		...
		if (proxyId1 > proxyId2){
			var temp:number /** uint */ = proxyId1;
			proxyId1 = proxyId2;
			proxyId2 = temp;
			//b2Math.b2Swap(p1, p2);
		}
		
		var hash:number /** uint */ = b2PairManager.Hash(proxyId1, proxyId2) & b2Pair.b2_tableMask;
		...
		var pIndex:number /** uint */ = this.m_freePair;
	...
	private RemovePair(proxyId1:number /** uint */, proxyId2:number /** uint */):any{
		...
		var node:number /** uint */ = this.m_hashTable[hash];
	...
	private FindHash(proxyId1:number /** uint */, proxyId2:number /** uint */, hash:number /** uint */):b2Pair{
		var pair:b2Pair;
		var index:number /** uint */ = this.m_hashTable[hash];
...
// static
	...
	{
		var key:number /** uint */ = ((proxyId2 << 16) & 0xffff0000) | proxyId1;
