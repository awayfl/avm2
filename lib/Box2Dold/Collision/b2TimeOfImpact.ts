...
export class b2TimeOfImpact
{
									...
									shape2:b2Shape, sweep2:b2Sweep) : number
	{
		...
		var p1:b2Vec2 = this.s_p1;
		var p2:b2Vec2 = this.s_p2;
		var k_maxIterations:number /** int */ = 20;	// TODO_ERIN b2Settings
		...
		for(;;)
		{
			...
			//b2XForm xf1, xf2;
			var xf1:b2XForm = this.s_xf1;
			var xf2:b2XForm = this.s_xf2;
