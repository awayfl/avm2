...
export class b2Collision{
											...
											poly2:b2PolygonShape, xf2:b2XForm):number
	{
		...
		var vertices1:b2Vec2[] = poly1.m_vertices;
		var normals1:b2Vec2[] = poly1.m_normals;
		
		var count2:number /** int */ = poly2.m_vertexCount;
		var vertices2:b2Vec2[] = poly2.m_vertices;
											...
											poly2:b2PolygonShape, xf2:b2XForm) : void
	{
		...
		var count2:number /** int */ = poly2.m_vertexCount;
		var vertices2:b2Vec2[] = poly2.m_vertices;
		var normals2:b2Vec2[] = poly2.m_normals;
											...
											polyB:b2PolygonShape, xfB:b2XForm) : void
	{
		...
		var edgeAO:number[] = [edgeA];
		var separationA:number = this.FindMaxSeparation(edgeAO, polyA, xfA, polyB, xfB);
		edgeA = edgeAO[0];
		if (separationA > 0.0)
			return;

		var edgeB:number /** int */ = 0;
		var edgeBO:number[] = [edgeB];
		var separationB:number = this.FindMaxSeparation(edgeBO, polyB, xfB, polyA, xfA);
		edgeB = edgeBO[0];
		if (separationB > 0.0)
			return;
		...
		var incidentEdge:ClipVertex[] = [new ClipVertex(), new ClipVertex()];
		...
		var clipPoints1:ClipVertex[] = [new ClipVertex(), new ClipVertex()];
		var clipPoints2:ClipVertex[] = [new ClipVertex(), new ClipVertex()];
		var np:number /** int */;
