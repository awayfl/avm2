...
export class b2RevoluteJoint extends b2Joint
{
	...
	public SolvePositionConstraints():boolean{
		...
		var impulseX:number = b2RevoluteJoint.tImpulse.x;
		var impulseY:number = b2RevoluteJoint.tImpulse.y;
		...
		if (this.m_enableLimit && this.m_limitState != b2RevoluteJoint.e_inactiveLimit)
		{
			var angle:number = b2.m_sweep.a - b1.m_sweep.a - this.m_referenceAngle;
