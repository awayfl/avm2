...
export class b2World
{
	...
	public Solve(step:b2TimeStep) : void{
		...
		var stack:b2Body[] = new Array(stackSize);
		...
		case b2Shape.e_polygonShape:
			{
				...
				var localVertices:b2Vec2[] = poly.GetVertices();
				
				//b2Assert(vertexCount <= b2_maxPolygonVertices);
				var vertices:b2Vec2[] = new Array(b2Settings.b2_maxPolygonVertices);
				...
				if (core)
				{
					var localCoreVertices:b2Vec2[] = poly.GetCoreVertices();
					for (i = 0; i < vertexCount; ++i)
					{
	...
	public DrawDebugData() : void{
		...
		if (flags & b2DebugDraw.e_pairBit)
		{
			...
			{
				var index:number /** uint */ = bp.m_pairManager.m_hashTable[i];
