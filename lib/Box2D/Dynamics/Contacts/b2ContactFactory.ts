...
export class b2ContactFactory
{
	...
	public Create(fixtureA:b2Fixture, fixtureB:b2Fixture):b2Contact{
		var type1:number /** int */ = fixtureA.GetType();
		var type2:number /** int */ = fixtureB.GetType();
	...
	public Destroy(contact:b2Contact) : void{
		...
		var type1:number /** int */ = contact.m_fixtureA.GetType();
		var type2:number /** int */ = contact.m_fixtureB.GetType();
