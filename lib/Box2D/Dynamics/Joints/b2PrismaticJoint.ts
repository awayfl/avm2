	...
	*/
	...
	public SolveVelocityConstraints(step:b2TimeStep) : void{
		...
		if (this.m_enableLimit && this.m_limitState != b2Joint.e_inactiveLimit)
		{
			...
			var f1:b2Vec3 = this.m_impulse.Copy();
			var df:b2Vec3 = this.m_K.Solve33(new b2Vec3(), -Cdot1X, -Cdot1Y, -Cdot2);
			...
			var bX:number = -Cdot1X - (this.m_impulse.z - f1.z) * this.m_K.col3.x;
			var bY:number = -Cdot1Y - (this.m_impulse.z - f1.z) * this.m_K.col3.y;
			var f2r:b2Vec2 = this.m_K.Solve22(new b2Vec2(), bX, bY)
			f2r.x += f1.x;
			f2r.y += f1.y;
		...
		else
		{
			...
			var df2:b2Vec2 = this.m_K.Solve22(new b2Vec2(), -Cdot1X, -Cdot1Y);
	...
	public SolvePositionConstraints(baumgarte:number ):boolean
	{
		...
		else
		{
			...
			var k12:number = i1 * this.m_s1 + i2 * this.m_s2;
			var k22:number = i1 + i2; 
			
			this.m_K.col1.Set(k11, k12, 0.0);
			this.m_K.col2.Set(k12, k22, 0.0);
			
			var impulse1:b2Vec2 = this.m_K.Solve22(new b2Vec2(), -C1X, -C1Y);
