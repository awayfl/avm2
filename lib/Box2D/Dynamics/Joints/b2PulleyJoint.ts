...
export class b2PulleyJoint extends b2Joint {
	...
	public GetLength1(): number {
		const p: b2Vec2 = this.m_bodyA.GetWorldPoint(this.m_localAnchor1);
	...
	public GetLength2(): number {
		const p: b2Vec2 = this.m_bodyB.GetWorldPoint(this.m_localAnchor2);
	...
	public InitVelocityConstraints(step: b2TimeStep): void{
		...
		if (step.warmStarting) {
			...
			const P1X: number = (-this.m_impulse - this.m_limitImpulse1) * this.m_u1.x;
			const P1Y: number = (-this.m_impulse - this.m_limitImpulse1) * this.m_u1.y;
			//b2Vec2 P2 = (-this.m_ratio * this.m_impulse - this.m_limitImpulse2) * this.m_u2;
			const P2X: number = (-this.m_ratio * this.m_impulse - this.m_limitImpulse2) * this.m_u2.x;
			const P2Y: number = (-this.m_ratio * this.m_impulse - this.m_limitImpulse2) * this.m_u2.y;
