...
export class b2Math
{
	...
	*/
	...
	public static MulTMV(A:b2Mat22, v:b2Vec2):b2Vec2
	{
		...
		var u:b2Vec2 = new b2Vec2(this.Dot(v, A.col1), this.Dot(v, A.col2));
		return u;
	}
	
	public static MulX(T:b2Transform, v:b2Vec2) : b2Vec2
	{
		var a:b2Vec2 = this.MulMV(T.R, v);
		a.x += T.position.x;
		a.y += T.position.y;
	...
	{
		var C:b2Mat22 = b2Mat22.FromVV(this.AddVV(A.col1, B.col1), this.AddVV(A.col2, B.col2));
		return C;
	}
	...
	{
		var C:b2Mat22 = b2Mat22.FromVV(this.MulMV(A, B.col1), this.MulMV(A, B.col2));
		return C;
	}
	...
	{
		var c1:b2Vec2 = new b2Vec2(this.Dot(A.col1, B.col1), this.Dot(A.col2, B.col1));
		var c2:b2Vec2 = new b2Vec2(this.Dot(A.col1, B.col2), this.Dot(A.col2, B.col2));
	...
	{
		var b:b2Vec2 = new b2Vec2(this.Abs(a.x), this.Abs(a.y));
		return b;
	}

	public static AbsM(A:b2Mat22):b2Mat22
	{
		var B:b2Mat22 = b2Mat22.FromVV(this.AbsV(A.col1), this.AbsV(A.col2));
		return B;
	}
	...
	{
		var c:b2Vec2 = new b2Vec2(this.Min(a.x, b.x), this.Min(a.y, b.y));
		return c;
	}
	...
	{
		var c:b2Vec2 = new b2Vec2(this.Max(a.x, b.x), this.Max(a.y, b.y));
		return c;
	}
